    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-10">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">サイト管理状況</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">管理者さん、お疲れさまです！今日のサイト状況をチェックしましょう。</p>
            </div>
            <div class="flex flex-wrap -m-4 text-center">
                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                        ...
                        <p class="leading-relaxed">ダウンロード数</p>
                    </div>
                </div>
                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                ...
                <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                    <a href="#">
                        <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                            ...
                            <p class="leading-relaxed">カテゴリ数</p>
                        </div>
                    </a>
                </div>
            </div>
